...
[submodule-dir-example/src/batt.c](./src/submodule-dir-example/src/batt.c), and
[submodule-dir-example/src/estimation.c](./src/submodule-dir-example/src/estimation.c) using the compiler flag
`-Isubmodule-dir-example/src` (i.e., adding the submodule's src directory in the includes path).
